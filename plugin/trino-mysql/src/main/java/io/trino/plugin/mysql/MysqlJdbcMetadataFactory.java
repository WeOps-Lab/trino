...
public class MysqlJdbcMetadataFactory
        extends DefaultJdbcMetadataFactory
{
    private final Set<JdbcQueryEventListener> jdbcQueryEventListeners;

    @Inject
    public MysqlJdbcMetadataFactory(JdbcClient jdbcClient, Set<JdbcQueryEventListener> jdbcQueryEventListeners)
    {
    ...
    {
        return new MysqlMetadata(transactionCachingJdbcClient, jdbcQueryEventListeners);
    }
}
