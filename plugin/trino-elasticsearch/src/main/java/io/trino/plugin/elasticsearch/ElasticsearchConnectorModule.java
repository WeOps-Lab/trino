...
import io.trino.plugin.elasticsearch.ptf.AlarmInfo;
        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        newSetBinder(binder, ConnectorTableFunction.class).addBinding().toProvider(AlarmInfo.class).in(Scopes.SINGLETON);
