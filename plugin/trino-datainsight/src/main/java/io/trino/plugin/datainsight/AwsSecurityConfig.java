...
@DefunctConfig("datainsight.aws.use-instance-credentials")
public class AwsSecurityConfig
{
    ...
    @Config("datainsight.aws.access-key")
    ...
    @Config("datainsight.aws.secret-key")
    ...
    @Config("datainsight.aws.iam-role")
    ...
    @Config("datainsight.aws.external-id")
