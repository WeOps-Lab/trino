...
public class DatainsightPlugin
        implements Plugin
{
    private final ConnectorFactory connectorFactory;

    public DatainsightPlugin()
    {
        connectorFactory = new DatainsightConnectorFactory();
    }

    @VisibleForTesting
    DatainsightPlugin(DatainsightConnectorFactory factory)
    {
