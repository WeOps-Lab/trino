        ...
        implements SystemTable
{
    private static final ConnectorTableMetadata METADATA = new ConnectorTableMetadata(
            ...
            ImmutableList.<ColumnMetadata>builder()
                    ...
                    .add(new ColumnMetadata("datainsight_node_id", createUnboundedVarcharType()))
                    .add(new ColumnMetadata("datainsight_node_address", createUnboundedVarcharType()))
                    .build());
    ...
    @Inject
    public NodesSystemTable(NodeManager nodeManager, DatainsightClient client)
    {
...
//    {
//        Set<DatainsightNode> nodes = client.getNodes();
//
...
//        BlockBuilder datainsightNodeId = VARCHAR.createBlockBuilder(null, nodes.size());
//        BlockBuilder datainsightAddress = VARCHAR.createBlockBuilder(null, nodes.size());
//
//        for (DatainsightNode node : nodes) {
...
//            VARCHAR.writeString(datainsightNodeId, node.getId());
//
//            if (node.getAddress().isPresent()) {
//                VARCHAR.writeString(datainsightAddress, node.getAddress().get());
//            }
//            else {
//                datainsightAddress.appendNull();
//            }
//        }
//
...
//                nodeId.build(),
//                prestoAddress.build(),
//                datainsightNodeId.build(),
//                datainsightAddress.build())));
//    }
}
