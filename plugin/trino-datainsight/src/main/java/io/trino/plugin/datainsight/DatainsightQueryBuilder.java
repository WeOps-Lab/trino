...
//public final class DatainsightQueryBuilder
//{
//    private DatainsightQueryBuilder() {}
//
//    public static QueryBuilder buildSearchQuery(TupleDomain<DatainsightColumnHandle> constraint, Optional<String> query, Map<String, String> regexes)
//    {
//        BoolQueryBuilder queryBuilder = new BoolQueryBuilder();
//        if (constraint.getDomains().isPresent()) {
//            for (Map.Entry<DatainsightColumnHandle, Domain> entry : constraint.getDomains().get().entrySet()) {
//                DatainsightColumnHandle column = entry.getKey();
