...
public final class DatainsightTableHandle
    ...
    public DatainsightTableHandle(Type type, String schema, String index, Optional<String> query) {
    ...
    public boolean equals(Object o) {
        ...
        DatainsightTableHandle that = (DatainsightTableHandle) o;
