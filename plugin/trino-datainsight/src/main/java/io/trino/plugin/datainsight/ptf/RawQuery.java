...
import io.trino.plugin.datainsight.DatainsightColumnHandle;
import io.trino.plugin.datainsight.DatainsightMetadata;
import io.trino.plugin.datainsight.DatainsightTableHandle;
...
import static io.trino.plugin.datainsight.DatainsightTableHandle.Type.RAW;
...
public class RawQuery
    ...
    @Inject
    public RawQuery(DatainsightMetadata metadata) {
    ...
    public static class RawQueryFunction
        ...
        public RawQueryFunction(DatainsightMetadata metadata) {
            super(
                    SCHEMA_NAME,
                    NAME,
                    List.of(
        ...
        public TableFunctionAnalysis analyze(
            ...
            String query = ((Slice) ((ScalarArgument) arguments.get("RAW")).getValue()).toStringUtf8();

            DatainsightTableHandle tableHandle = new DatainsightTableHandle(RAW, schema, index, Optional.of(query));
    ...
    public static class RawQueryFunctionHandle
        ...
        @JsonCreator
        public RawQueryFunctionHandle(@JsonProperty("tableHandle") DatainsightTableHandle tableHandle) {
