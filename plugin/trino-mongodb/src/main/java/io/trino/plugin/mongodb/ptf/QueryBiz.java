        ...
        implements Provider<ConnectorTableFunction>
{
    ...
    public static final String NAME = "get_biz";

    private final MongoMetadata metadata;
    private final MongoSession session;

    @Inject
    public QueryBiz(MongoSession session)
    {
            ...
            extends AbstractConnectorTableFunction
    {
        ...
        public TableFunctionAnalysis analyze(
            ...
            String collection = "cc_applicationbase";
            ...
            CMDBBizQueryFunctionHandle handle = new CMDBBizQueryFunctionHandle(tableHandle);
    ...
    public static class CMDBBizQueryFunctionHandle
            implements ConnectorTableFunctionHandle
    {
        private final MongoTableHandle tableHandle;

        @JsonCreator
        public CMDBBizQueryFunctionHandle(@JsonProperty("tableHandle") MongoTableHandle tableHandle)
        {
